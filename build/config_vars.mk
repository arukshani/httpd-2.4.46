exp_exec_prefix = /opt/loc
rel_exec_prefix =
exp_bindir = /opt/loc/bin
rel_bindir = bin
exp_sbindir = /opt/loc/bin
rel_sbindir = bin
exp_libdir = /opt/loc/lib
rel_libdir = lib
exp_libexecdir = /opt/loc/modules
rel_libexecdir = modules
exp_mandir = /opt/loc/man
rel_mandir = man
exp_sysconfdir = /opt/loc/conf
rel_sysconfdir = conf
exp_datadir = /opt/loc
rel_datadir =
exp_installbuilddir = /opt/loc/build
rel_installbuilddir = build
exp_errordir = /opt/loc/error
rel_errordir = error
exp_iconsdir = /opt/loc/icons
rel_iconsdir = icons
exp_htdocsdir = /opt/loc/htdocs
rel_htdocsdir = htdocs
exp_manualdir = /opt/loc/manual
rel_manualdir = manual
exp_cgidir = /opt/loc/cgi-bin
rel_cgidir = cgi-bin
exp_includedir = /opt/loc/include
rel_includedir = include
exp_localstatedir = /opt/loc
rel_localstatedir =
exp_runtimedir = /opt/loc/logs
rel_runtimedir = logs
exp_logfiledir = /opt/loc/logs
rel_logfiledir = logs
exp_proxycachedir = /opt/loc/proxy
...
AP_LIBS = $(MOD_SO_LDADD) $(MOD_HTTP_LDADD) $(MOD_MPM_EVENT_LDADD) /opt/httpd-2.4.46/srclib/apr-util/libaprutil-1.la -lexpat /opt/httpd-2.4.46/srclib/apr/libapr-1.la -luuid -lrt -lcrypt -lpthread -ldl
AP_BUILD_SRCLIB_DIRS = apr apr-util
AP_CLEAN_SRCLIB_DIRS = apr-util apr
HTTPD_VERSION = 2.4.46
HTTPD_MMN = 20120211
abs_srcdir = /opt/httpd-2.4.46
...
LOAD_ALL_MODULES = no
APR_BINDIR = /opt/loc/bin
APR_INCLUDEDIR = /opt/httpd-2.4.46/srclib/apr/include
APR_VERSION = 1.7.0
APR_CONFIG = /opt/loc/bin/apr-1-config
APU_BINDIR = /opt/loc/bin
APU_INCLUDEDIR = /opt/httpd-2.4.46/srclib/apr-util/include
APU_VERSION = 1.6.1
APU_CONFIG = /opt/loc/bin/apu-1-config
