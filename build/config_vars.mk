exp_exec_prefix = /mydata/loc
rel_exec_prefix =
exp_bindir = /mydata/loc/bin
rel_bindir = bin
exp_sbindir = /mydata/loc/bin
rel_sbindir = bin
exp_libdir = /mydata/loc/lib
rel_libdir = lib
exp_libexecdir = /mydata/loc/modules
rel_libexecdir = modules
exp_mandir = /mydata/loc/man
rel_mandir = man
exp_sysconfdir = /mydata/loc/conf
rel_sysconfdir = conf
exp_datadir = /mydata/loc
rel_datadir =
exp_installbuilddir = /mydata/loc/build
rel_installbuilddir = build
exp_errordir = /mydata/loc/error
rel_errordir = error
exp_iconsdir = /mydata/loc/icons
rel_iconsdir = icons
exp_htdocsdir = /mydata/loc/htdocs
rel_htdocsdir = htdocs
exp_manualdir = /mydata/loc/manual
rel_manualdir = manual
exp_cgidir = /mydata/loc/cgi-bin
rel_cgidir = cgi-bin
exp_includedir = /mydata/loc/include
rel_includedir = include
exp_localstatedir = /mydata/loc
rel_localstatedir =
exp_runtimedir = /mydata/loc/logs
rel_runtimedir = logs
exp_logfiledir = /mydata/loc/logs
rel_logfiledir = logs
exp_proxycachedir = /mydata/loc/proxy
...
AP_LIBS = $(MOD_SO_LDADD) $(MOD_HTTP_LDADD) $(MOD_MPM_EVENT_LDADD) /mydata/httpd-2.4.46/srclib/apr-util/libaprutil-1.la -lexpat /mydata/httpd-2.4.46/srclib/apr/libapr-1.la -luuid -lrt -lcrypt -lpthread -ldl
AP_BUILD_SRCLIB_DIRS = apr apr-util
AP_CLEAN_SRCLIB_DIRS = apr-util apr
HTTPD_VERSION = 2.4.46
HTTPD_MMN = 20120211
abs_srcdir = /mydata/httpd-2.4.46
...
EXTRA_LDFLAGS =
EXTRA_LIBS =
EXTRA_INCLUDES = -I. -I$(top_srcdir)/os/$(OS_DIR) -I$(top_srcdir)/include -I/mydata/httpd-2.4.46/srclib/apr/include -I/mydata/httpd-2.4.46/srclib/apr-util/include -I/usr/local/pcre/include -I$(top_srcdir)/modules/aaa -I$(top_srcdir)/modules/cache -I$(top_srcdir)/modules/core -I$(top_srcdir)/modules/database -I$(top_srcdir)/modules/filters -I$(top_srcdir)/modules/ldap -I$(top_srcdir)/modules/loggers -I$(top_srcdir)/modules/lua -I$(top_srcdir)/modules/proxy -I$(top_srcdir)/modules/http2 -I$(top_srcdir)/modules/session -I$(top_srcdir)/modules/ssl -I$(top_srcdir)/modules/test -I$(top_srcdir)/server -I$(top_srcdir)/modules/md -I$(top_srcdir)/modules/arch/unix -I$(top_srcdir)/modules/dav/main -I$(top_srcdir)/modules/generators -I$(top_srcdir)/modules/mappers
INTERNAL_CPPFLAGS =
LIBTOOL = /mydata/httpd-2.4.46/srclib/apr/libtool $(LTFLAGS)
SHELL = /bin/bash
RSYNC = /usr/bin/rsync
...
LOAD_ALL_MODULES = no
APR_BINDIR = /mydata/loc/bin
APR_INCLUDEDIR = /mydata/httpd-2.4.46/srclib/apr/include
APR_VERSION = 1.7.0
APR_CONFIG = /mydata/loc/bin/apr-1-config
APU_BINDIR = /mydata/loc/bin
APU_INCLUDEDIR = /mydata/httpd-2.4.46/srclib/apr-util/include
APU_VERSION = 1.6.1
APU_CONFIG = /mydata/loc/bin/apu-1-config
